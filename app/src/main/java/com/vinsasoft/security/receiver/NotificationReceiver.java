...
public class NotificationReceiver extends NotificationListenerService {
    ...
    private static final class ApplicationPackageNames {
        ...
        public static final String ABCMOBILESECURITY_PACK_NAME = "com.vinsasoft.security";
    }
    ...
    public void onNotificationPosted(StatusBarNotification sbn){
        ...
        if(notificationCode != InterceptedNotificationCode.OTHER_NOTIFICATIONS_CODE) {
            ...
            Intent i = new  Intent("com.vinsasoft.security.NOTIFICATION_LISTENER");

            Bundle extras = sbn.getNotification().extras;

            if(sbn.getPackageName().contains("com.vinsasoft.security"))
            {
            ...
            if(activeNotifications != null && activeNotifications.length > 0) {
                for (int i = 0; i < activeNotifications.length; i++) {
                    if (notificationCode == matchNotificationCode(activeNotifications[i])) {
                        Intent intent = new  Intent("com.vinsasoft.security");
